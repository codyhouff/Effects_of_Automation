...
max_parameters = df2[df2.groupby(['Domain'])['Parameters'].transform(max) == df2['Parameters']].drop_duplicates(subset='Parameters', keep="first").sort_values('Parameters')
