...
#print(df[:52])
##########################################
fig1 = px.scatter(df, x='Year', y=['Top 1 (FLOP/s)'], log_y=True, trendline="ols", trendline_options=dict(log_y=True), hover_name='Top 1 model', color_discrete_sequence=['rgb(99, 110, 250)'])
...
fig.update_layout(
        title = {'text': 'Computing Power (FLOP/s)','y':0.9,'x':0.5,'xanchor': 'center','yanchor': 'top'},
        yaxis_title="FLOP/s",
